...
// int cnt = 0;  // 可能方案的个数
// char order[16]; // 这一路上，他一共遇到店5次，遇到花10次。最后一个数组元素放'\0'
// void fun(int num, int flower, int store, int remainingWine)
// {
//     // num：在进行函数中的各项操作前 李白 已遇到花和店 的次数
//     // flower：在进行函数中的各项操作前 李白 已遇到花 的次数
//     // store：在进行函数中的各项操作前 李白 已遇到店 的次数
//     // remainingWine：在进行函数中的各项操作前 酒壶中剩余的酒
