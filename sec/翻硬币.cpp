...
1
*/
// 分析：贪心算法，从前往后遍历初始状态字符串，如果发现当前硬币和目标硬币状态不一样，则同时翻转这枚硬币和下一枚硬币
// #include <string.h> // AC
// #include <stdio.h>
// const int N = 1000;
...
//     for (int i = 0; originalState[i] != '\0'; i++)
//     {
//         if (originalState[i] != targetState[i])
//         {
//             turn(originalState, i);
//             count++;
//         }
//     }
